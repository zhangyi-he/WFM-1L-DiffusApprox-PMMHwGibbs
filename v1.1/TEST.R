...
pdf(file = "./Output/Output v1.0/TEST v1.1/TEST_SimData.pdf", width = 16, height = 12)
...
pdf(file = "./Output/Output v1.0/TEST v1.1/TEST_BPF_Particle.pdf", width = 24, height = 66)
...
save(sel_cof, dom_par, pop_siz, ref_siz, raw_smp, ptn_num, pcl_num, itn_num, PMMH,
     file = "./Output/Output v1.0/TEST v1.1/TEST_PMMH.rda")

load("./Output/Output v1.0/TEST v1.1/TEST_PMMH.rda")

sel_cof_chn <- PMMH

pdf(file = "./Output/Output v1.0/TEST v1.1/TEST_PMMH_Traceplot.pdf", width = 8, height = 6)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
save(sel_cof, dom_par, pop_siz, ref_siz, raw_smp, ptn_num, pcl_num, itn_num, brn_num, thn_num, BayesianProcedure,
     file = "./Output/Output v1.0/TEST v1.1/TEST_BayesProc.rda")

load("./Output/Output v1.0/TEST v1.1/TEST_BayesProc.rda")
...
pdf(file = "./Output/Output v1.0/TEST v1.1/TEST_BayesProc_Posterior.pdf", width = 8, height = 6)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(sel_cof_chn, breaks = seq(min(sel_cof_chn), max(sel_cof_chn), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Posterior for selection coefficient")
