...
// [[Rcpp::export]]
List runBPF_arma(const double& sel_cof, const double& dom_par, const int& pop_siz, const arma::imat& raw_smp, const arma::uword& ptn_num, const arma::uword& pcl_num) {
  // ensure RNG gets set/reset
  RNGScope scope;
...
// [[Rcpp::export]]
List calculateOptimalParticleNum_arma(const double& sel_cof, const double& dom_par, const int& pop_siz, const arma::imat& raw_smp, const arma::uword& ptn_num, const arma::uword& pcl_num, const arma::uword& gap_num) {
  // ensure RNG gets set/reset
  RNGScope scope;
...
//[[Rcpp::export]]
arma::drowvec runPMMH_arma(const double& sel_cof, const double& dom_par, const int& pop_siz, const arma::imat& raw_smp, const arma::uword& ptn_num, const arma::uword& pcl_num, const arma::uword& itn_num) {
  // ensure RNG gets set/reset
  RNGScope scope;
