...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_SimData.pdf", width = 16, height = 12)
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_BPF_Particle.pdf", width = 24, height = 66)
...
save(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, raw_smp, ptn_num, pcl_num, itn_num, PMMH,
     file = "./Output/Output v1.0/TEST v1.2/TEST_PMMH.rda")

load("./Output/Output v1.0/TEST v1.2/TEST_PMMH.rda")

sel_cof_chn <- PMMH

pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_PMMH_Traceplot.pdf", width = 16, height = 6)
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_PMMH_Posterior_SelCoeff.pdf", width = 16, height = 6)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_PMMH_Posterior_SelChange.pdf", width = 12, height = 6)
...
save(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, raw_smp, ptn_num, pcl_num, itn_num, stp_siz, apt_rto, PMMH,
     file = "./Output/Output v1.0/TEST v1.2/TEST_AdaptPMMH.rda")

load("./Output/Output v1.0/TEST v1.2/TEST_AdaptPMMH.rda")

sel_cof_chn <- PMMH

pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_AdaptPMMH_Traceplot.pdf", width = 16, height = 6)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient before event")
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_AdaptPMMH_Posterior_SelCoeff.pdf", width = 16, height = 6)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(sel_cof_chn[1, ], breaks = seq(min(sel_cof_chn[1, ]), max(sel_cof_chn[1, ]), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Posterior for selection coefficient before event")
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_AdaptPMMH_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
...
save(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, raw_smp, ptn_num, pcl_num, itn_num, brn_num, thn_num, adp_set, stp_siz, apt_rto, BayesianProcedure,
     file = "./Output/Output v1.0/TEST v1.2/TEST_BayesProc.rda")

load("./Output/Output v1.0/TEST v1.2/TEST_BayesProc.rda")
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_BayesProc_Posterior.pdf", width = 16, height = 6)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(sel_cof_chn[1, ], breaks = seq(min(sel_cof_chn[1, ]), max(sel_cof_chn[1, ]), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Posterior for selection coefficient before event")
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_BayesProc_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
