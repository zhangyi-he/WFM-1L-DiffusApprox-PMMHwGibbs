...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_GEN_SimData.pdf", width = 16, height = 12)
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_GEN_BPF_Particle.pdf", width = 24, height = 66)
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_GEN_PMMH_Traceplot.pdf", width = 16, height = 6)
...
save(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, sel_cof_chn,
     file = "./Output/Output v1.0/TEST v1.2/TEST_GEN_AdaptPMMH.rda")

load("./Output/Output v1.0/TEST v1.2/TEST_GEN_AdaptPMMH.rda")

pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_GEN_AdaptPMMH_Traceplot.pdf", width = 16, height = 6)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient before event")
...
pdf(file = "./Output/Output v1.0/TEST v1.2/TEST_GEN_BayesProc_Posterior.pdf", width = 16, height = 6)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(sel_cof_chn[1, ], breaks = seq(min(sel_cof_chn[1, ]), max(sel_cof_chn[1, ]), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Posterior for selection coefficient before event")
