...
for (i in 1:sim_num) {
  print(i)
  smp_WFM[i] <- cmpsimulateWFM(sel_cof, dom_par, pop_siz, int_frq, evt_gen, int_gen, lst_gen)[(lst_gen - int_gen) + 1]
...
save(model, sel_cof, dom_par, pop_siz, int_con, evt_gen, smp_gen, smp_siz, smp_cnt, smp_frq, pop_frq,
     file = "./Output/Output v1.0/TEST v1.3/TEST_GEN_SimData.rda")

load("./Output/Output v1.0/TEST v1.3/TEST_GEN_SimData.rda")

pdf(file = "./Output/Output v1.0/TEST v1.3/TEST_GEN_SimData.pdf", width = 16, height = 12)
...
system.time(BPF <- cmprunBPF(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num))

save(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, BPF,
     file = "./Output/Output v1.0/TEST v1.3/TEST_GEN_BPF.rda")

load("./Output/Output v1.0/TEST v1.3/TEST_GEN_BPF.rda")
...
pdf(file = "./Output/Output v1.0/TEST v1.3/TEST_GEN_BPF_Likelihood.pdf", width = 8, height = 6)
...
pdf(file = "./Output/Output v1.0/TEST v1.3/TEST_GEN_BPF_Particle.pdf", width = 24, height = 66)
...
for (k in 1:length(smp_gen)) {
  ...
  hist(pop_frq_pst_resmp[1, , k], breaks = seq(min(pop_frq_pst_resmp[1, , k], pop_frq_pre_resmp[1, , k]), max(pop_frq_pst_resmp[1, , k], pop_frq_pre_resmp[1, , k]), length.out = 50), freq = FALSE, col = rgb(0.1, 0.1, 0.1, 0.5),
       ...
       main = paste("Genotype AA at generation", smp_gen[k]))
...
system.time(OptNum <- calculateOptimalParticleNum(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, gap_num))

save(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, gap_num, OptNum,
     file = "./Output/Output v1.0/TEST v1.3/TEST_GEN_OptNum.rda")

load("./Output/Output v1.0/TEST v1.3/TEST_GEN_OptNum.rda")

opt_pcl_num <- OptNum$opt_pcl_num
log_lik_sdv <- OptNum$log_lik_sdv

pdf(file = "./Output/Output v1.0/TEST v1.3/TEST_GEN_OptNum.pdf", width = 8, height = 6)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
load("./Output/Output v1.0/TEST v1.3/TEST_1L_SimData.rda")
...
system.time(sel_cof_chn <- cmprunPMMH(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num))

load("./Output/Output v1.0/TEST v1.3/TEST_GEN_SimData.rda")

save(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, sel_cof_chn,
     file = "./Output/Output v1.0/TEST v1.3/TEST_GEN_PMMH.rda")

load("./Output/Output v1.0/TEST v1.3/TEST_GEN_PMMH.rda")

pdf(file = "./Output/Output v1.0/TEST v1.3/TEST_GEN_PMMH_Traceplot.pdf", width = 16, height = 6)
...
pdf(file = "./Output/Output v2.0/Test v1.0/TEST_1L_PMMH_Posterior.pdf", width = 16, height = 6)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
system.time(sel_cof_chn <- cmprunAdaptPMMH(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num))

load("./Output/Output v1.0/TEST v1.3/TEST_GEN_SimData.rda")

save(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, sel_cof_chn,
     file = "./Output/Output v1.0/TEST v1.3/TEST_GEN_AdaptPMMH.rda")

load("./Output/Output v1.0/TEST v1.3/TEST_GEN_AdaptPMMH.rda")

pdf(file = "./Output/Output v1.0/TEST v1.3/TEST_GEN_AdaptPMMH_Traceplot.pdf", width = 16, height = 6)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient before event")
...
pdf(file = "./Output/Output v2.0/Test v1.0/TEST_1L_AdaptPMMH_Posterior.pdf", width = 16, height = 6)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(sel_cof_chn[1, ], breaks = seq(min(sel_cof_chn[1, ]), max(sel_cof_chn[1, ]), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Posterior for selection coefficient before event")
...
system.time(BayesianProcedure <- cmprunBayesianProcedure(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, brn_num, thn_num))

load("./Output/Output v1.0/TEST v1.3/TEST_GEN_SimData.rda")

save(sel_cof, dom_par, pop_siz, ref_siz, evt_gen, smp_gen, smp_siz, smp_cnt, ptn_num, pcl_num, itn_num, brn_num, thn_num, BayesianProcedure,
     file = "./Output/Output v1.0/TEST v1.3/TEST_GEN_BayesProc.rda")

load("./Output/Output v1.0/TEST v1.3/TEST_GEN_BayesProc.rda")
...
pdf(file = "./Output/Output v1.0/TEST v1.3/TEST_GEN_BayesProc_Posterior.pdf", width = 16, height = 6)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(sel_cof_chn[1, ], breaks = seq(min(sel_cof_chn[1, ]), max(sel_cof_chn[1, ]), length.out = 50), freq = FALSE,
     xlab = "Selection coefficient",
     main = "Posterior for selection coefficient before event")
